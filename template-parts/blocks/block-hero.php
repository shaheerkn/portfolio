...
<pre>
  ...
  <span class="dot">······</span>{ <span class="string">'2021-now' : 'Freelance developer at Upwork' </span>}
  <span class="dot">······</span>{ <span class="string">'2021-now' : 'Freelance Webdeveloper at Softoo' </span>}
  <span class="dot">····</span>]
  <span class="dot">··</span>}
  <span class="dot">··</span><span class="propname">portfolio()</span> {
  <span class="dot">····</span><span class="method">return</span> [
  <span class="dot">······</span>{ <span class="string">'Softoo' : <a href="https://softoo.co/">'https://softoo.co/'</a> </span>}
  <span class="dot">······</span>{ <span class="string">'Wishin' : <a href="https://wishin.org/">'https://wishin.org/'</a> </span>}
  <span class="dot">······</span>{ <span class="string">'Joovv' : <a href="https://joovv.com/">'https://joovv.com/'</a> </span>}
  <span class="dot">······</span>{ <span class="string">'SCT' : <a href="https://www.sctechglobal.com/">'https://www.sctechglobal.com/'</a> </span>}
  <span class="dot">····</span>]
  <span class="dot">··</span>}
  ...
  <span class="dot">............</span><span class="string">'Webpack/Gulp/Vite', 'SCSS/Less', 'npm/yarn/pnpm', "Figma/Sketch</span> ]
  <span class="dot">··</span>}
  }
</pre>
</div>
